...
final class Version20220225191542 extends \Doctrine\Migrations\AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tickets (id SERIAL NOT NULL, client_id INT NOT NULL, session_id INT NOT NULL, place SMALLINT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX tickets_client_fkey ON tickets (client_id)');
        ...
        $this->addSql('ALTER TABLE tickets ADD CONSTRAINT tickets_client_fkey FOREIGN KEY (client_id) REFERENCES users (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
