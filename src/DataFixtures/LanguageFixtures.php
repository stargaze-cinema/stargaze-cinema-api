...
{
    public const NUMBER = 181;

    public function load(ObjectManager $manager): void
    {
        for ($i = 0; $i <= self::NUMBER; $i++) {
            $language = new Language();
            $language->setName(self::LANGUAGELIST[$i]['name']);
            $language->setCode(self::LANGUAGELIST[$i]['code']);
            $language->setNativeName(self::LANGUAGELIST[$i]['nativeName']);
    ...
    public const LANGUAGELIST = [
        ...
        ["code" => "ik", "name" => "Inupiaq", "nativeName" => "Iñupiatun"],
